...
initial_centers = kmeans_plusplus_weighted_initialization_vincenty(data', n_clusters, rand(500), 0.5)
...
function fuzzy_correlator(ra::Vector{Float64}, 
    ...
    new_weights = calculate_weights(weights, data, centers, fuzziness, dist_metric)
